...
import { changeUserType, getUserChildren, getUserController, updateUserController } from '../controllers/user.controller';
...
export const userRouter = router({
  ...
  getUserChildren: privateProcedure.query((req) => getUserChildren({ ctx: req.ctx })),
